 ...
 * @author Filip
 */
public class Databasedasdsad {

    private SQLiteDB db;

    static private Databasedasdsad instance = null;

    public static Databasedasdsad getInstance() {

	if (instance == null) {
	    instance = new Databasedasdsad();
